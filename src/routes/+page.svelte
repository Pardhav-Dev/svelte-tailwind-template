...
<div class="relative isolate overflow-hidden bg-white">
	<div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
			<div class="flex ">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-11 w-11 mr-2" viewBox="0 0 107 128"
			...
			<p class="mt-6 text-lg leading-8 text-gray-600">
				Your project has been created and has following dependecies:
			</p>
			<ul class="text-lg leading-8 text-gray-600 font-mono">
				{#each data.tech as t}
					<li>{t}</li>
				{/each}
			</ul>
